/**
 * servicios.gs — TODOS los servicios en un solo archivo (fusión de los 22 svc_*.gs).
...
const PLANT_COMODINES_SRV = ['encabezado', 'dia', 'fase', 'via_aerea', 'soporte', 'parametros',
  ...
  'pafi', 'sedacion_escalon', 'sas', 'sas_meta', 'sas_palabras', 'gcs', 'vigilia', 'cooperacion', 'hdn', 'dva',
