...
si('el esquema trae la hoja PLANTILLAS_EVOLUCION y EVOLUCIONES no cambió por esto', /PLANTILLAS_EVOLUCION: \{ headerRows: 1/.test(lee('esquema.gs')) && /TOTAL_COLS\.EVOLUCIONES !== 411/.test(lee('esquema.gs')));   // 🗂️ 397 desde el 16-sep-2026: VENT_INTERFAZ
