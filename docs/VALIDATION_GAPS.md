...
- SAS, IMS, MRC, FSS y CPAx validan rangos existentes en legacy. GCS deriva su total
  de componentes y conserva 1T. El resto sigue en texto libre y no está validado.
